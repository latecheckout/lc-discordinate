  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-gradient-to-br from-background to-secondary">
      ...
      >
        ...
        >
          <h1 className="text-3xl font-bold text-primary">Discordinate</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Play games together with your community
          </p>
        </motion.div>
        ...
        >
          <Button
            variant="default"
            size="lg"
            className="w-full flex items-center justify-center gap-3 bg-[#5865F2] hover:bg-[#4752C4] text-white"
